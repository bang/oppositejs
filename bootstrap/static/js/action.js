...
export default class Action {
    ...
    replaceTemplate(obj, target, display, keep_content, position, structure_string){
        /* Parses the list and put the data into html as the template replacing variables marked
            with ${}. One nasted level is allowed in the case list item is an associative array. Besides, it's able
            to replace vars
            Ex:
            Template file 'templates/examples/repeat.html'
            -------------
            ...
            ---------
               <div id="my_div"
                    replace_template='{
                        "template": "templates/examples/repeat.html"
                        "vars": [
                            {"roses_color": "red"},
                            {"violet_color": "blue"}
                        ]
            ...
            -----------------------------
                ...
                this.action.repeatList(mydiv, mydiv)
