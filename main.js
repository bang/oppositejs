...
This module gets the 'starter_module' from config.js and set the template into 'main' div into the 'home' page. Besides,
 does the same for every custom template.
