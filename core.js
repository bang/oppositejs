/* core.js
That is the 'heart' of the project. All new HTML attributes, action, event etc. are processed in this module
...
export default class Core {
    ...
    _processEventAttribute(event, element, event_name) {
        /* Links an event to a method in some module */
    ...
    _addEvent(event_name) {
        /* Registrates an event to an event handlers */
    ...
    updateElementsEvents(elements_ids, event_name){
        /*Updates an event using an id element as reference*/
